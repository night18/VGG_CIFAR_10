...
if __name__ == '__main__':
	...
	train_data, validation_data = train_data[0:800], train_data[800:1000]
	train_labels, validation_labels = train_labels[0:800], train_labels[800:1000]
	...
	for x in learning_rate_list:
		...
		if model == None:
			model = vgg_train.trainModel("vgg_11", train_data, train_labels, validation_data, validation_labels, epochs = 2, learning_rate = x)
